...
| Cloudflare DNS (1.1.1.1), as the tailnet's nameserver | Free public resolver, no account | Tailnet devices' lookups (not the VM's) | None in money; Cloudflare sees those lookups instead of the carrier | Set in Tailscale admin → DNS; removable |
